...
const translations = {
  en: {
    ...
    section3Title: "Telemetry",
    section3Text: "The desktop app does not include invasive telemetry. Basic diagnostic logs may be written to local files to help with debugging and error reporting, and you can review or delete these logs at any time from your system.",
  ...
  ar: {
    ...
    section3Title: "القياس عن بُعد",
    section3Text: "تطبيق سطح المكتب لا يتضمن قياسات تطفلية. قد يتم كتابة سجلات تشخيص أساسية إلى ملفات محلية للمساعدة في التصحيح والإبلاغ عن الأخطاء، ويمكنك مراجعة أو حذف هذه السجلات في أي وقت من نظامك.",
